...
#
# Script generated by Vivado on Thu Oct 10 04:54:00 MSK 2024
...
design_libs_elab="-libname xilinx_vip -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_17 -libname processing_system7_vip_v1_0_19 -libname xil_defaultlib -libname xlconcat_v2_1_6 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip axi_infrastructure_v1_1_0 axi_vip_v1_1_17 processing_system7_vip_v1_0_19 xil_defaultlib xlconcat_v2_1_6)
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../zynq_test.gen/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"../../../../zynq_test.gen/sources_1/bd/system/ipshared/b28c/hdl" +incdir+"/mnt/big_chungus/vivada/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../zynq_test.gen/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"../../../../zynq_test.gen/sources_1/bd/system/ipshared/b28c/hdl" +incdir+"/mnt/big_chungus/vivada/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_vip_v1_1_17 $xmvlog_opts -sv +incdir+"../../../../zynq_test.gen/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"../../../../zynq_test.gen/sources_1/bd/system/ipshared/b28c/hdl" +incdir+"/mnt/big_chungus/vivada/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../zynq_test.gen/sources_1/bd/system/ipshared/4d04/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work processing_system7_vip_v1_0_19 $xmvlog_opts -sv +incdir+"../../../../zynq_test.gen/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"../../../../zynq_test.gen/sources_1/bd/system/ipshared/b28c/hdl" +incdir+"/mnt/big_chungus/vivada/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../zynq_test.gen/sources_1/bd/system/ipshared/b28c/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../zynq_test.gen/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"../../../../zynq_test.gen/sources_1/bd/system/ipshared/b28c/hdl" +incdir+"/mnt/big_chungus/vivada/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../bd/system/ip/system_processing_system7_0_0/sim/system_processing_system7_0_0.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xlconcat_v2_1_6 $xmvlog_opts +incdir+"../../../../zynq_test.gen/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"../../../../zynq_test.gen/sources_1/bd/system/ipshared/b28c/hdl" +incdir+"/mnt/big_chungus/vivada/Vivado/2024.1/data/xilinx_vip/include" \
