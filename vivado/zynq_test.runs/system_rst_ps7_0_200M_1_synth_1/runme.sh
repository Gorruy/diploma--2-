...
HD_PWD='/home/gorruy/Desktop/diploma--2-/vivado/zynq_test.runs/system_rst_ps7_0_200M_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_rst_ps7_0_200M_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_rst_ps7_0_200M_1.tcl
