...
HD_PWD='/home/gorruy/Desktop/diploma--2-/vivado/zynq_test.runs/system_acc_top_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_acc_top_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_acc_top_0_0.tcl
